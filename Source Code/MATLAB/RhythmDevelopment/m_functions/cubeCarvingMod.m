...
% Date: June 23, 2016
% Author: Roman Pryamonosov
% Date: November 14, 2017

% Modification Log:
% Modified by Roman Pryamonosov (November 14, 2017):
% 1) The heartMask was added to create a binary representation of the
%    segmented heart
% 2) The MarchingCubes algorithm inputs heart mask to generate heart
%    surface. Since the surface is generated inside of MatLab, there is no 
%    need to call C++ code.
% 3) Operating system check is added to provide a proper way of dealing
%    with file or folder paths
% 4) some useless code was removed
%% Code %%
