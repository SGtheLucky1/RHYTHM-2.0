...
%
% January 8, 2017 - Start of FIT3 (Automatic junction detection)
% 1) Remove tools for user specified calibration point assignment, reduce 4
% windows to 1
% 2) Add thresholding tools to isolate the cube
% 3) Add thresholding tools to isolte the grid
% 4) Add control for dictating how many neighbors junctions will have, type
% of thresholding
% 5) Add tools for removing artifact points and adding missed points
% 6) Add algorithm for automatically numbering them for calibration
%
%% CODE %%
...
%                 gridThreshSlider,skeletonConnDrop,skeletonRun,resetImage],'Enable','on')
            ...
            set([cubeGrab,resetImage],'Enable','on')
