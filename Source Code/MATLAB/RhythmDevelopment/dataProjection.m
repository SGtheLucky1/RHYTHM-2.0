function [dataProj,geommasks,mask] = dataProjection(Xshift,Yshift,shift,norms,...
    centroids,cells,pts,neighs,neighnum,Parmap,Posmap,camera,bg,...
    geommasks,nr,nc,looknmap,cmosData,fps,opt_dir,filename)
...
% % %     gg=acos(gg);
% % %     gg=real(gg);
% % %     langle(:,1:nviews)=gg.*180/pn;  % only x and y components
% % % end
